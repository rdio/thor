...
class FilterParserSpec extends BaseSpec {
  ...
  "Parser" should "be able to parse a layer" in {
    parser.parseAll(parser.layer, "http://localhost/album/0/1/2/a.png").get should be (LayerNode(UrlNode("http://localhost/album/0/1/2/a.png"), NoopNode()))
    parser.parseAll(parser.layer, "http://localhost/album/0/3/4/b.png:blur()").get should be (LayerNode(UrlNode("http://localhost/album/0/3/4/b.png"), BlurNode()))
  ...
  "Parser" should "be able to parse multiple layers" in {
    parser.parseAll(parser.layers, "http://localhost/album/0/1/2/a.png;$0:blur()").get should be {
      List(
        LayerNode(UrlNode("http://localhost/album/0/1/2/a.png"), NoopNode()),
